...
- Train an ARIMA model (AutoARIMA makes parameter selection easier).
- Use fitted (in-sample) reconstruction and prediction intervals.
- Flag points outside the interval as anomalies.
- Tune interval level (95/99) for sensitivity vs. false positives.
- Visualize results to validate and iterate.
